...
$outout = array("status"=>false, "message"=>"");

if($data["apikey"] != "1492507516844"){
    
    
    echo json_encode(array("status"=>0, "message"=>"Not valid api key"));
...
$list1 = array("aPostdata"=>json_decode($a1),"aPost2"=>json_decode($apostData), "httpurl"=>$httpUrl, "header"=>$headers,"aresponse"=>json_decode($aresponse), "httpCode"=>$httpcode,"output"=>$output);
//echo json_encode($list1);
    ...
    echo json_encode(array("status"=>$t1, "message"=>$m, "data"=>$output));
