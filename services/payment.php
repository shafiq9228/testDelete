...
$postad = $db->query("INSERT INTO transactions (`pincode`,`transid`,`userid`,`merchant`,`merchantname`,`paidby`,`customerno`,`amount`,`message`,`status`,`date`,`datetime`,`payment_id`) VALUES ('$reg[pincode]','$val','$userid','0','Dakshinpay','$reg[name]','$reg[mobile]','$amount','Amount settled to dakshinpay','Credit','$date','$datetime','$payment_id')");
...
$tr = $db->query("UPDATE bills SET status = 'Paid',paidon = '$date',paidfrom = 'url' WHERE  userid = '$userid' and status = 'Pending' and guid = '".$billid."' ");
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   background: #032553;  border-radius: 10px; ">
      ...
      <tr>
        <td align="center" class="late style7" style="padding-bottom: 0px;">Thank you</td>
      </tr>
      ...
      <tr>
        <td align="center" style="padding-bottom: 0px;"><p class="due">
          ...
          Has been received to our Dakshin Pay Account ('.$info[mobile].') . Your transaction ID is #'.$val.'. </p></td>
      </tr>
