...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.pay2all.in/v1/payment/verification?optional1='.$optional1,
  ...
  CURLOPT_POSTFIELDS => 'number='.$number.'&provider_id='.$provider_id.'&api_id=27',
...
$result =  "Successdelli".$arr['amount'].'delli'.$arr['name'].'delli'.$arr['duedate'].'delli'.$arr['message'].'delli'.$arr['reference_id'];
