...
require '../phpmailler/PHPMailerAutoload.php';
  ...
  $mail->isHTML(true);
  $mail->Subject='You have received a payment of Rs.'.$amount.'';
...
<table width="600" height="559" border="0" align="center" cellpadding="30" cellspacing="0" class="bg" style=" background-size: cover; background-position:bottom;">
  ...
  <tr>
    <td height="212"><p>Dear  Customer,</p>
      <p>INR '.$amount.' credited to your account '.$info[bank].' with account no '.$info[account].'  on '.date('d-m-Y h:i',strtotime($datetime)).' IST from DakshinPay.</p>
