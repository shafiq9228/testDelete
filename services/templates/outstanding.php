...
<table width="600" height="599" border="0" align="center" cellpadding="0" cellspacing="0" class="bg" style=" background-size: cover; background-position:bottom;">
  ...
  <tr>
    <td height="324" align="center"><p>&nbsp;</p>
      ...
      <h2 class="style3">Ourstanding Payment Alert</h2>
      <p class="style3 style9">&nbsp;</p>
      <p class="style3 style4" style="margin: 0;"><span class="style7">&#8377;</span> '.$total.'*</p>
      <p class="style3">From '.date("d M",strtotime($fromdate)).' to '.date("d M",strtotime($todate)).'</p>
      <p class="style3">Last date to pay: '.date('d-m-Y',strtotime($duedate)).'</p>
      <p class="style3 style9">&nbsp;</p>
      <p class="style3"><a href="https://www.dakshinpay.com/services/paymentrequest.php?paymentid='.$last_id.'" style="border-radius: 100px; padding:10px; width:150px; background:white; border: 0; font-weight:bold; color: #3babff; font-size: 20px;">PAY NOW</a></p>
      <p class="style3">&nbsp;</p></td>
  </tr>
  <tr>
