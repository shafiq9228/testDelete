...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://kyc-api.aadhaarkyc.io/api/v1/income/epfo/passbook/generate-otp',
...
if($arr['success'] == true){    
    ...
    $sql = $db->query("UPDATE register SET pf_client_id = '".$arr[data][client_id]."',pf_status = 'Pending',pfno = '$pfno'  WHERE  guid = '".$tempuserid."' ");


    $result  = array(
        'status'  => true,
        'client_id'=>$arr[data][client_id],
        'message' =>'OTP sent to '.$arr[data][masked_mobile_number]
        ); 
